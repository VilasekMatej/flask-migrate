...
from .models import Contact, ContactGroup, Gender, CompanyGroup, Products
...
class ProductModelView(ModelView):
    ...
    list_columns = ["product", "company"]

    base_order = ("product", "company_group.name")
    show_fieldsets = [
        ("Info", {"fields": ["product", "company"]}),
    ]
...
class CompanyGroupView(ModelView):
...
appbuilder.add_view(
    ...
    "List of Companies",
    icon="fa-folder-open-o",
    category="Companies and Products",
    category_icon="fa-envelope",
)
appbuilder.add_view(
...
appbuilder.add_view(
    ProductModelView, "List Products", icon="fa-envelope", category="Companies and Products"
)
